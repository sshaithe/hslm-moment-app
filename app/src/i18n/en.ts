export const en = {
  ...
  bannedMessage: 'Your access to this wedding gallery has been suspended by the administrator.',
  guests: 'Guests',
  ban: 'Ban',
  unban: 'Unban',
  banned: 'Banned',
  active: 'Active',
  guestsSubtitle: 'View and manage active guest sessions, and suspend access if necessary.',
  searchGuests: 'Search guests by name...',
